    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.convertspeed.ConvertSpeeds.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.convertspeed.ConvertSpeeds.class.getResource(".");
